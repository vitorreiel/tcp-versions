...
def create_topology():
    ...
    net.addLink(h1, r1, loss=0, delay='0ms') # 100Gbps/0%/10ms
    net.addLink(h2, r2, loss=0, delay='0ms') # 100Gbps/0%/10ms

    # Link routers
    net.addLink(r1, r2, loss=1, delay='10ms', intfName1="r1-eth1", intfName2="r2-eth1") # 100Gbps/1%/10ms
